...
class RegistrationPatient extends StatefulWidget {
  static const String sr = 'registration_patient';
  const RegistrationPatient({Key? key});
...
// Retrieve the user's UID
  ...
  Future addUserDetails(String firstName, String lastName, String email,
    ...
    String collectionName = userType == 'doctor' ? 'doctors' : 'patient';
        ...
        child: Column(
          ...
          children: [
            IconButton(
              ...
              onPressed: () {
                Navigator.pushNamed(context, LoginPatient.sr);
              },
            ),
            Container(
              height: 200,
