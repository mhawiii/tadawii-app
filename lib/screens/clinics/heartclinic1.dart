...
class heartclinic1 extends StatefulWidget {
  static const String sr = 'heartclinic1';
  @override
  _heartclinic1State createState() => _heartclinic1State();
}

class _heartclinic1State extends State<heartclinic1> {
      ...
      body: Stack(children: [
        Container(
         ...
         ${clinicData['clinicName']} -
           معنا يتم تقديم رعاية متخصصة لصحة القلب والأوعية الدموية، بواسطة فريق مؤهل من الأطباء والممرضين، باستخدام تقنيات حديثة لتشخيص وعلاج مختلف الحالات القلبية بفعالية 
           ''',
                                      style: GoogleFonts.ibmPlexSansArabic(
                                        fontSize: 20,
                                    ...
                                    FutureBuilder<List<TimeSlot>>(
                                      future: firestoreService
                                          .getTimeSlotsForClinic(
                                              '2'), // Specify the clinic name here
