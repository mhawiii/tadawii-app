...
class PtClinic1 extends StatelessWidget {
  @override
...
class pTClinic1 extends StatefulWidget {
  @override
  _pTClinic1State createState() => _pTClinic1State();
}

class _pTClinic1State extends State<pTClinic1> {
                                    ...
                                    FutureBuilder<List<TimeSlot>>(
                                      future: firestoreService
                                          .getTimeSlotsForClinic(
                                              '1'), // Specify the clinic name here
