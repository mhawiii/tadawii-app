...
class RSettingScreen extends StatelessWidget {
  final String userId;

  const RSettingScreen({Key? key, required this.userId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return FutureBuilder<DocumentSnapshot>(
      future: FirebaseFirestore.instance.collection('recep').doc(userId).get(),
