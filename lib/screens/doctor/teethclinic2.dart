...
class tClinic2 extends StatelessWidget {
  @override
...
class TClinic2 extends StatefulWidget {
  @override
  _TClinic2State createState() => _TClinic2State();
}

class _TClinic2State extends State<TClinic2> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(children: [
